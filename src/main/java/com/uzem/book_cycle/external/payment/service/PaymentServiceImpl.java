...
import com.uzem.book_cycle.external.payment.dto.TossErrorResponse;
...
import static com.uzem.book_cycle.external.payment.type.PaymentPurpose.OVERDUE;
import static com.uzem.book_cycle.external.payment.type.PaymentStatus.CANCELED;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponseDTO requestTossApi(PaymentRequestDTO request) {
        try{
            ...
            headers.set("Idempotency-Key", UUID.randomUUID().toString()); // 멱등 키
